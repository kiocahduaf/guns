...
) ENGINE=InnoDB AUTO_INCREMENT=1071611686130278403 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='字典表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1078664217834541059 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='登录记录';
